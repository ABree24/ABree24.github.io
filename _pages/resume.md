...
- Handled **IT support requests** and achieved a **95% resolution rate** within established SLAs.  
- Created **technical documentation** for configuration and update procedures to streamline maintenance.  
...
- Improved shop workflow through better coordination and reporting consistency.
...
|-----------|----------------------|
| **Security Tools** | Microsoft Sentinel, Nessus, Burp Suite, Wireshark, Metasploit |
| **Programming & Automation** | PowerShell, Python (basic automation), Bash |
...
|----------|--------------|-------|
| **Brute-Force Attack Detection using Microsoft Sentinel** | Built a KQL analytic rule to detect and respond to brute-force attacks in a simulated SOC environment. | Sentinel, KQL, PowerShell |
| **Network Traffic Analysis** | Captured and analyzed packets to identify abnormal traffic patterns. | Wireshark, TCPDump | (HackTheBox)
